# Generated by Django 4.2 on 2024-01-31 05:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 143117))),
            ],
        ),
        migrations.CreateModel(
            name='company_master',
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 141999))),
            ],
        ),
        migrations.CreateModel(
            name='message_master',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.CharField(max_length=30)),
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 142997))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_time', models.DateTimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 141400))),
                ('provider_operator_code', models.CharField(max_length=30)),
                ('provision_completion_flag', models.BooleanField(default=False)),
                ('delivery_completion_time', models.TimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 141533))),
                ('order_cancellation_flag', models.BooleanField(default=False)),
                ('order_cancellation_time', models.TimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 141540))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_time', models.DateTimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 141867))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pdf_file', models.FileField(blank=True, null=True, upload_to='', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf'])])),
                ('transaction_time', models.DateTimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 141720))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 142159))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 142635))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 31, 5, 56, 51, 142275))),
