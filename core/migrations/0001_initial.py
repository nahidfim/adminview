    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registration_time",
                    models.TimeField(
                        default=datetime.datetime(2023, 8, 14, 7, 59, 1, 368516)
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registration_time",
                    models.TimeField(
                        default=datetime.datetime(2023, 8, 14, 7, 59, 1, 371192)
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order_time",
                    models.TimeField(
                        default=datetime.datetime(2023, 8, 14, 7, 59, 1, 368120)
                    ),
                ),
                ...
                (
                    ...
                    models.TimeField(
                        default=datetime.datetime(2023, 8, 14, 7, 59, 1, 368147)
                    ),
                ),
                ...
                (
                    ...
                    models.TimeField(
                        default=datetime.datetime(2023, 8, 14, 7, 59, 1, 368159)
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registration_time",
                    models.TimeField(
                        default=datetime.datetime(2023, 8, 14, 7, 59, 1, 368840)
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "category_name",
                    models.CharField(default="Sushi", max_length=90, null=True),
                ),
                (
                    "page_number",
                    models.IntegerField(default=1, max_length=90, null=True),
                ),
                (
                    "registration_time",
                    models.TimeField(
                        default=datetime.datetime(2023, 8, 14, 7, 59, 1, 370375)
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registration_time",
                    models.TimeField(
                        default=datetime.datetime(2023, 8, 14, 7, 59, 1, 369350)
                    ),
                ),
                (
                    "product_category_no",
                    models.ManyToManyField(
                        to="core.product_category_master",
                        verbose_name="Product Category Number",
                    ),
                ),
            ],
            options={"unique_together": {("tablet_page_no", "category_page_no")},},
        ),
    ]
