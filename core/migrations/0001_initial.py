# Generated by Django 4.1.1 on 2024-03-19 04:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 916801))),
            ],
        ),
        migrations.CreateModel(
            name='company_master',
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 915703))),
            ],
        ),
        migrations.CreateModel(
            name='message_master',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.CharField(max_length=30)),
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 916649))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_time', models.DateTimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 914948))),
                ('provider_operator_code', models.CharField(max_length=30)),
                ('provision_completion_flag', models.BooleanField(default=False)),
                ('delivery_completion_time', models.TimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 915046))),
                ('order_cancellation_flag', models.BooleanField(default=False)),
                ('order_cancellation_time', models.TimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 915053))),
                ('product_image_link_dest', models.TextField(max_length=50)),
                ('settlement_date', models.DateField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 915060))),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_time', models.DateTimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 915362))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pdf_file', models.FileField(blank=True, null=True, upload_to='', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf'])])),
                ('transaction_time', models.DateTimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 915241))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 915858))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 916328))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 3, 19, 4, 4, 15, 915977))),
