# Generated by Django 4.2 on 2024-01-04 10:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 4, 10, 28, 6, 44771))),
            ],
        ),
        migrations.CreateModel(
            name='company_master',
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 4, 10, 28, 6, 42854))),
            ],
        ),
        migrations.CreateModel(
            name='message_master',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.CharField(max_length=30)),
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 4, 10, 28, 6, 44565))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_time', models.DateTimeField(default=datetime.datetime(2024, 1, 4, 10, 28, 6, 41902))),
                ('provider_operator_code', models.CharField(max_length=30)),
                ('provision_completion_flag', models.BooleanField(default=False)),
                ('delivery_completion_time', models.TimeField(default=datetime.datetime(2024, 1, 4, 10, 28, 6, 42243))),
                ('order_cancellation_flag', models.BooleanField(default=False)),
                ('order_cancellation_time', models.TimeField(default=datetime.datetime(2024, 1, 4, 10, 28, 6, 42257))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_time', models.DateTimeField(default=datetime.datetime(2024, 1, 4, 10, 28, 6, 42588))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 4, 10, 28, 6, 43070))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 4, 10, 28, 6, 43902))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_time', models.TimeField(default=datetime.datetime(2024, 1, 4, 10, 28, 6, 43272))),
